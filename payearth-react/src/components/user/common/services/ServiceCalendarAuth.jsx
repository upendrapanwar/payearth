...
function ServiceCalendarAuth(props) {
  const { serviceCreator, serviceName, sellerId} = props;
  ...
  return (
    <React.Fragment>
      <div style={{ marginTop: "30px", marginBottom: "50px" }}>
        ...
        {isAuthenticated && <ServiceCalendar serviceCreator={serviceCreator} serviceName={serviceName} sellerId={sellerId}/>}
      </div>
    </React.Fragment>
  );
}
