            ...
            <div className="post" >
                <div className="post_head">
                    ...
                    <div className="post_on">
                        ...
                        <span>{posts.productId !== null && posts.productId !== "" && posts.categoryId !== null && posts.categoryId !== "" && '|'}</span>
                        {
                            posts.productId !== null && posts.productId !== "" && posts.categoryId !== null && posts.categoryId !== "" &&
