...
class Chat extends Component {
    ...
    fetchAllUserData = () => {
        ...
        try {
            ...
            const url = `/seller/fetchChat/${authorId}`
            axios.get(url, {
                headers: {
    ...
    fetchAllBlockChat = () => {
        try {
            const authorId = this.authInfo.id
            const url = `/seller/fetchBlockChat/${authorId}`
            axios.get(url, {
                headers: {
                    'Accept': 'application/json',
                    'Content-Type': 'application/json;charset=UTF-8',
    ...
    handleSearch = async () => {
        if (!this.state.search) {
            ...
            try {
                const response = await axios.get(`/seller/getAllUser?search=${this.state.search}`, {
                    headers: {
                        'Authorization': `Bearer ${this.authInfo.token}`
                    },
                });
    ...
    selectAllUsers = async () => {
        try {
            const response = await axios.get(`/seller/getAllUser`, {
                headers: {
                    'Authorization': `Bearer ${this.authInfo.token}`
                },
            });
    ...
    createGroupChat = () => {
        ...
        if (selectedUsers.length > 1) {
            try {
                const url = '/seller/createGroupChat';
    ...
    getAllMessage = (chatId) => {
        axios.get(`seller/allMessages/${chatId}`, {
            headers: {
                'Authorization': `Bearer ${this.authInfo.token}`
            },
        }).then((response) => {
    ...
    handleSearchText = async (e) => {
        ...
        try {
            ...
            const response = await axios.get(`/seller/getAllUser?search=${search}`, {
                headers: {
                    'Authorization': `Bearer ${this.authInfo.token}`
                },
            });
    ...
    clickToAddUser = async (data) => {
        ...
        try {
            const url = `seller/addGroupMember/${sendChatData.chatId}`;
    ...
    handleChatBlock = (data) => {
        {
            data.isBlock === false ?
                axios.put(`/seller/userChatBlock/${data.chatId}`, { isBlock: true, blockByUser: this.authInfo.id }, {
                    headers: {
                        'Accept': 'application/json',
                        'Content-Type': 'application/json;charset=UTF-8',
                        'Authorization': `Bearer ${this.authInfo.token}`
                ...
                :
                axios.put(`/seller/userChatBlock/${data.chatId}`, { isBlock: false, blockByUser: null }, {
                    headers: {
                        'Accept': 'application/json',
                        'Content-Type': 'application/json;charset=UTF-8',
                        'Authorization': `Bearer ${this.authInfo.token}`
    ...
    handleUnblockChat = (chatId) => {
        try {
            axios.put(`/seller/userChatBlock/${chatId}`, { isBlock: false, blockByUser: null }, {
                headers: {
                    'Accept': 'application/json',
                    'Content-Type': 'application/json;charset=UTF-8',
                    'Authorization': `Bearer ${this.authInfo.token}`
    ...
    handleRemoveFromGroup = (chatId, userId) => {
        ...
        try {
            const url = "/seller/removeFromGroup/";
        ...
        return (
            <React.Fragment>
                ...
                <section className="inr_wrap">
                    <Helmet><title>{"Seller - Chat - Pay Earth"}</title></Helmet>
