        ...
        if (data.finalizedInvoice.status === "paid") {
            ...
            reqBody = {
                data: {
                    ...
                    billingCompanyName: "",
                    billingCounty: userData.address.country,
                    billingPhone: userData.phone,
                    billingPostCode: userData.address.zip,
                    billingStreetAddress: userData.address.street,
                    billingStreetAddress1: userData.address.street,
