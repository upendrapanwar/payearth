...
class MyOrders extends Component {
      ...
      .then((response) => {
        ...
        if (response.data.data.data) {
          const formattedData = response.data.data.data.map((item) => {
            const date = new Date(item.order.paymentId.createdAt).toLocaleDateString();
            ...
            if (item.order.id) {
              ...
              formattedItem.amountPaid = item.order.paymentId.amountPaid.toFixed(2);
              ...
              formattedItem.paymentStatus = item.order.paymentId.paymentStatus;
              ...
              formattedItem.paymentStatus = "N/A";
              formattedItem.amountPaid = "N/A";
              formattedItem.orderStatus = "N/A";
            }
    ...
    const itemRows = row.orderDetails.length > 0 ?
      ...
      <div class="row mb-4">
            <div class="col-4">
              ...
              <div class="col-4">
                <div class="fw-bold mt-2">Transaction Date:</div>
      ...
      <table class="table">
        <tbody>
          ...
          <tr class="text-end">
            <td></td>
            <td class="fw-bold" style="width: 200px">AMOUNT PAID</td>
            <td class="text-end" style="width: 100px">$ ${amountPaid}</td>
          </tr>
        </tbody>
      </table>
      </div>
  ...
  data_column = [
    ...
    },
    {
      ...
      selector: (row, i) => row.transactionDate,
      sortable: true,
            ...
            {selectedRowData && (
              ...
              <div className="p-4 cart-mob-p0">
                <Row className="mb-4">
                  ...
                  <Col md={4}>
                    <div className="fw-bold mt-2">Transaction Date:</div>
                    <div>{selectedRowData.transactionDate || ''}</div>
                ...
                <Table>
                  <tbody>
                    ...
                    <tr className="text-end">
                      <td></td>
                      <td className="fw-bold" style={{ width: '150px' }}>AMOUNT PAID</td>
                      <td className="text-end" style={{ width: '100px' }}>$ {selectedRowData.amountPaid}</td>
                    </tr>
                  </tbody>
                </Table>
