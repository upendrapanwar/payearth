...
class ProductDetail extends Component {
  ...
  componentDidMount() {
    ...
    axios
      .get("front/product/similar-products/" + productId)
      .then((response) => {
        let productsData = [];
    ...
    return (
      <React.Fragment>
          ...
          <div className="container">
            <div className="row g-0 bg-white rounded">
              <div className="col-md-7">
                <ProductView
                  featuredImg={this.state.thumbnails[0]}
                ...
                <div className="prod_dtl_info">
                  <div className="prod_dtl_body">
                    <div className="pdi_ratings">
                      ...
                      >
                        ( {this.state.productDetail.reviewCount} Reviews )
                      </Link>
                    </div>
                    ...
                    <div className="pdi_avblty">
                      ...
                      | Product Code :{" "}
                      <span>{this.state.productDetail.productCode}</span>
                    </div>
                    <div className="pdi_desc">
                      <p>
                        {this.state.productDetail.description
                          ? parse(this.state.productDetail.description)
                          : ""}
                      </p>
                    </div>
                  ...
                  <div className="pdi_share">
                    <div className="pdi_seller">
                      Seller :{" "}
                      <b>
                        {this.state.productDetail.createdBy
                          ? this.state.productDetail.createdBy.name
                          : ""}
                      </b>{" "}
        ...
        {this.state.similarProducts && this.state.similarProducts.length > 0 ? (
          <SimilarProducts
            products={this.state.similarProducts}
            isService={false}
          />
        ) : (
          ""
